                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col-12">
                                                        <input type="text" class="form-control" name="title" placeholder="Title" value="<%=blog.getTitle()%>">
                                                    </div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-12">
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col-12">
                                                        <textarea class="form-control" name="content" rows="5" placeholder="Content"><%=blog.getContent()%></textarea>
                                                    </div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-12">
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col-12">
                                                        <input class="form-control" name="url" rows="5" placeholder="Link"value="<%=blog.getUrl()%>">
                                                    </div>
                                                </div>
                                        </div>
